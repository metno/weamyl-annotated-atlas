...
var xTest = '<?xml version="1.0" encoding="ISO-8859-1" standalone="no"?>\n' +
    '<csw:GetRecords\n' +
...
async function getModelData() {
  ...
  console.log('SENDASearch: ', response.data);
  var xml = response.data;
  var xmlDoc = xml.responseXML;
  var x = xmlDoc.getElementsByTagName('WMS');
  console.log('XMLDOC: ', x);
  return response;
}
